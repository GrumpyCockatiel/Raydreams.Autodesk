...
namespace Raydreams.Autodesk.CLI.Data
{
	...
	public partial class DataManagerRepository : IDataManagerAPI
	{
		...
		//	// add the file body
		//	message.Content = new ByteArrayContent( file.File );
		//	message.Content.Headers.ContentLength = file.Filelength;
		...
		//	try
		//	{
		//		HttpClient client = new HttpClient() { Timeout = this.DownloadTimeout };
